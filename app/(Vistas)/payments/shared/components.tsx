...
const Icon = ({ name, size = 20, stroke = 1.5, className = "" }: any) => {
  ...
  const paths: any = {
    ...
    heart: <path d="M12 20s-7-4.5-9-9.5C1.5 6 5 3 8 4.5c1.7.8 3 2 4 3.5 1-1.5 2.3-2.7 4-3.5 3-1.5 6.5 1.5 5 6-2 5-9 9.5-9 9.5z"/>,
    ...
    starFill: <path d="m12 3 2.9 5.9 6.5.9-4.7 4.6 1.1 6.5L12 17.8l-5.8 3.1 1.1-6.5L2.6 9.8l6.5-.9z" fill="currentColor"/>,
    filter: <path d="M3 5h18M6 12h12M10 19h4"/>,
    truck: <><path d="M3 7h11v10H3zM14 11h4l3 3v3h-7"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/></>,
    ...
    qr: <><path d="M3 3h7v7H3zM14 3h7v7h-7zM3 14h7v7H3z"/><path d="M14 14h2v2h-2zM18 14h3v3M14 18h2v3h5v-2"/></>,
    creditCard: <><rect x="2" y="6" width="20" height="13" rx="2"/><path d="M2 11h20M6 15h3"/></>,
    bank: <><path d="M3 10h18L12 4z"/><path d="M5 10v8M9 10v8M15 10v8M19 10v8M3 18h18M4 21h16"/></>,
    copy: <><rect x="8" y="8" width="11" height="11" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v1"/></>,
    wallet: <><path d="M3 7a2 2 0 0 1 2-2h13v4H5a2 2 0 0 0-2 2zM3 11v6a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-7a1 1 0 0 0-1-1H5a2 2 0 0 1-2-2z"/><circle cx="17" cy="14" r="1"/></>,
    ...
    pkgOut: <><path d="M3 7l9-4 9 4-9 4z"/><path d="M3 7v10l9 4 9-4V7"/><path d="M12 11v10M15 14l-3 3-3-3"/></>,
    ...
    phone: <path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2 4.2 2 2 0 0 1 4 2h3a2 2 0 0 1 2 1.7 13 13 0 0 0 .7 2.8 2 2 0 0 1-.5 2.1L8 9.9a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.1-.5 13 13 0 0 0 2.8.7A2 2 0 0 1 22 16.9z"/>,
    logout: <><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4M16 17l5-5-5-5M21 12H9"/></>,
    upload: <><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M17 8l-5-5-5 5M12 3v12"/></>,
    camera: <><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></>,
    image: <><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-5-5L5 21"/></>,
    tag: <><path d="M20.6 13.4 13 21a2 2 0 0 1-2.8 0L3 13.8V3h10.8l7 7a2 2 0 0 1 0 2.8z"/><circle cx="7.5" cy="7.5" r="1.5"/></>,
    sparkle: <path d="m12 3 2 5 5 2-5 2-2 5-2-5-5-2 5-2zM18 14l1 2.5 2.5 1-2.5 1L18 21l-1-2.5L14.5 17.5 17 16.5z"/>,
    leaf: <><path d="M21 3c-9 0-15 6-15 14 0 1 0 2 .3 3 5-1 9-3 12-7 2-3 3-7 3-10z"/><path d="M3 21c2-6 5-9 9-12"/></>,
    ...
    bath: <><path d="M3 12V6a2 2 0 0 1 4 0M3 12h18v3a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4zM5 19l-1 2M19 19l1 2"/></>,
    sofa: <><path d="M3 12v3a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-3M3 12a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v3M21 12a2 2 0 0 0-2-2h0a2 2 0 0 0-2 2v3M7 12a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2"/></>,
    ...
    flower: <><circle cx="12" cy="12" r="3"/><path d="M12 2a4 4 0 0 1 0 8M12 14a4 4 0 0 1 0 8M2 12a4 4 0 0 1 8 0M14 12a4 4 0 0 1 8 0"/></>,
    ...
    flame: <path d="M12 2s4 4 4 8a4 4 0 0 1-8 0c0-2 1-3 2-4-1 4 3 4 3 0 0-2-1-3-1-4zM6 14a6 6 0 0 0 12 0c0 5-3 8-6 8s-6-3-6-8z"/>,
    helmet: <><path d="M4 16a8 8 0 0 1 16 0v3H4z"/><path d="M9 8c1-3 3-4 3-4s2 1 3 4"/></>,
...
const Button = ({ children, variant = "primary", size = "md", icon, iconRight, full, onClick, disabled, type = "button", className = "" }: any) => {
  ...
  const stateCls = disabled ? "opacity-50 cursor-not-allowed" : "cursor-pointer active:scale-[0.98]";
  return (
    <button
      type={type}
      onClick={onClick}
...
const useToast = () => {
  ...
  const ToastHost = () => (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[9999] flex flex-col gap-2 pointer-events-none">
      {toasts.map(t => {
        const toneCls = t.tone === "success" ? "bg-forest" : t.tone === "danger" ? "bg-danger" : "bg-ink";
        return (
          <div key={t.id} className={`text-paper px-[18px] py-2.5 rounded-full text-[13px] shadow-sh-3 font-medium animate-toast-in ${toneCls}`}>
            {t.msg}
          </div>
        );
      })}
...
const ProductGlyph = ({ kind, palette = ["#a4ac86", "#656d4a"], size = 80 }: any) => {
  const glyphs: any = {
    bath: <><circle cx="40" cy="40" r="22" fill={palette[0]}/><path d="M28 42c4-2 20-2 24 0" stroke={palette[1]} strokeWidth="2" fill="none" strokeLinecap="round"/></>,
    cocina: <><rect x="20" y="22" width="40" height="38" rx="4" fill={palette[0]}/><path d="M30 32h20M30 42h20M30 52h12" stroke={palette[1]} strokeWidth="2" strokeLinecap="round"/></>,
    comedor: <><circle cx="40" cy="34" r="14" fill={palette[0]}/><rect x="36" y="48" width="8" height="14" fill={palette[1]}/></>,
    dormitorio: <><rect x="14" y="34" width="52" height="22" rx="3" fill={palette[0]}/><rect x="20" y="28" width="16" height="10" rx="2" fill={palette[1]}/></>,
    decoracion: <><circle cx="40" cy="40" r="18" fill={palette[0]}/><path d="M32 40c4-8 12-8 16 0" stroke={palette[1]} strokeWidth="2" fill="none"/></>,
    living: <><rect x="14" y="36" width="52" height="20" rx="6" fill={palette[0]}/><rect x="20" y="30" width="12" height="8" rx="2" fill={palette[1]}/><rect x="48" y="30" width="12" height="8" rx="2" fill={palette[1]}/></>,
    terraza: <><path d="M40 18 22 50h36z" fill={palette[0]}/><rect x="36" y="50" width="8" height="14" fill={palette[1]}/></>,
    box: <><path d="M20 28 40 18l20 10v22L40 60 20 50z" fill={palette[0]}/><path d="M20 28 40 38l20-10M40 38v22" stroke={palette[1]} strokeWidth="2"/></>,
  };
  return (
...
const SectionTitle = ({ eyebrow, children, action }: any) => (
  <div className="flex justify-between items-end mb-4">
    <div>
      {eyebrow && <div className="font-mono text-[11px] uppercase tracking-[0.08em] text-ink-3 mb-1.5">{eyebrow}</div>}
      <h2 className="m-0 text-2xl font-semibold tracking-[-0.02em] text-ink">{children}</h2>
    </div>
    {action}
  </div>
);
...
const Logo = ({ size = 28, label = true, color = "currentColor" }: any) => (
  <div className="inline-flex items-center gap-2.5">
    <svg width={size} height={size} viewBox="0 0 32 32" className="shrink-0">
      <path d="M6 26 V14 C6 9, 10 5, 16 5 C22 5, 26 9, 26 14 V26" stroke={color} strokeWidth="2" fill="none" strokeLinecap="round"/>
      <path d="M11 26 V18 C11 15, 13 13, 16 13 C19 13, 21 15, 21 18 V26" stroke={color} strokeWidth="2" fill="none" strokeLinecap="round"/>
      <circle cx="16" cy="14" r="1.5" fill={color}/>
    </svg>
    {label && <span className="font-semibold tracking-[-0.02em]" style={{ fontSize: size * 0.6, color }}>UniHousing</span>}
  </div>
);
export { Logo };
    ...
    {tabs.map((t: any) => {
      ...
      return (
        ...
        >
          {label}
          {count != null && (
            <span className={`text-[11px] px-[7px] py-0.5 rounded-full font-semibold ${isActive ? "bg-forest text-paper" : "bg-bone text-ink-3"}`}>{count}</span>
          )}
        </button>
      );
    })}
...
const AppShellHeader = ({ appName, appColor, onBack }: any) => (
  <div className="sticky top-0 z-50 bg-paper/85 backdrop-blur-[12px] border-b border-line px-5 py-2.5 flex items-center justify-between">
    <a href="../index.html" className="inline-flex items-center gap-2.5 text-ink-3 text-[13px]">
      <Icon name="arrowLeft" size={16}/> Hub
    </a>
    <div className="flex items-center gap-2 text-[13px] font-mono text-ink-3">
      <span className="w-2 h-2 rounded-full" style={{ background: appColor }}></span>
      {appName}
    </div>
  </div>
);
